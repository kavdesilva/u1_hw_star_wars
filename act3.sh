...
mv star_wars/empire/death_star/chewbacca.txt star_wars/empire/death_star/millenium_falcon/chewbacca.txt
mv star_wars/empire/death_star/luke_skywalker.txt star_wars/empire/death_star/millenium_falcon/luke_skywalker.txt
mv star_wars/empire/death_star/han_solo.txt star_wars/empire/death_star/millenium_falcon/han_solo.txt
mv star_wars/empire/death_star/princess_leia.txt star_wars/empire/death_star/millenium_falcon/princess_leia.txt
...
mv star_wars/empire/death_star/darth_vader.txt star_wars/empire/darth_vader.txt
